...
var Monster = cc.Node.extend({
    ...
    MonsterDestroyAction:function(){
        var l_pos = this.MonsterAmature.getPosition();
        this.MonsterAmature.stopAllActions();
        this.MonsterAmature.removeFromParent(true);
        ...
        switch (this.MonsterIndex)
        {
            ...
            {
                this.MonsterGroundDestroyAction(l_pos);
            }
                break;
            case MonsterType.MonsterSky_enum:
            {
                this.MonsterSkyDestroyAction(l_pos);
            }
                break;
            default:
                break;
    ...
    random:function(start, end){
        ...
        var i = Math.random()*(end-start+1)+start;
        return i | 0;
    },
