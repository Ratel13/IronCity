...
var SettingUI = cc.Layer.extend({
    ...
    init:function(effectStatus, volumn){
            ...
            this.uiLayer.addWidget(ccs.GUIReader.getInstance().widgetFromJsonFile(Json_GameSceneSetMenu_1));
            this.addChild(this.uiLayer);

            this.musicEffectSlider = this.uiLayer.getWidgetByName("musicEffect");
            this.musicVolumeSlider = this.uiLayer.getWidgetByName("musicVolume");
            var backGameBtn = this.uiLayer.getWidgetByName("backGame");
            var returnMainMenuBtn = this.uiLayer.getWidgetByName("returnMainMenu");
